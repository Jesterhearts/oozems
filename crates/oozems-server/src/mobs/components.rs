...
pub(super) struct MobMotion {
    ...
    pub roam_right: f32,
    pub move_speed: f32,
    pub base_wz_speed: i32,
    pub speed_penalty: i32,
    pub slow_expires_at_ms: u64,
    pub can_move: bool,
    pub can_jump: bool,
    pub flies: bool,
    pub flip_x: bool,
...
pub(super) struct MobCombat {
    ...
    pub maximum_hp: u64,
    pub current_hp: u64,
    pub stagger_threshold: u64,
    pub stagger_duration_ms: u64,
    ...
    pub movement_resume_mode: Option<MobMovementMode>,
...
pub(super) struct PlayerPresence {
    ...
    pub enemy_slow: Option<crate::effects::EnemySlowEffect>,
